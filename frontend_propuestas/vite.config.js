...
export default defineConfig({
  ...
  server: {
    proxy: {
      '/api': {
        target: 'http://localhost:3000', // Puerto backend Express
        changeOrigin: true,
      },
    },
  },
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Desarrollador de Propuestas de Evenor - Soluciones Tecnológicas',
        short_name: 'Desarrollador de Propuestas de Evenor - Soluciones Tecnológicas',
        ...
        shortcuts: [
          {
            name: 'Inicio',
            short_name: 'Inicio',
            description: 'Desarrollador de Propuestas de Evenor - Soluciones Tecnológicas',
            url: '/',
          ...
          },
          {
            name: 'Contacto',
            short_name: 'Contacto',
            description: 'Contactar con Desarrollador de Propuestas de Evenor - Soluciones Tecnológicas',
            url: '/contacto',
            icons: [{ src: '/pwa-icons/icon-96x96.png', sizes: '96x96' }]
          }
        ]
